...
save_dir = os.path.join(os.path.abspath(os.path.expanduser("~")),f".codenames")
...
# Load board image
board = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/board.png"),winSize)

# Load images
cardSize = (5*61,3*60)
cardImg = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/word-card.png"),cardSize)
cardSelectImg = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/word-card-select.png"),cardSize)
cardRedImg = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/word-card-red.png"),cardSize)
cardBlueImg = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/word-card-blue.png"),cardSize)
cardBlackImg = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/word-card-black.png"),cardSize)
redImg1 = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/red1.png"),cardSize)
redImg2 = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/red2.png"),cardSize)
redImg3 = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/red1.png"),cardSize)
redImg4 = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/red2.png"),cardSize)
redImgs = [redImg1,redImg2,redImg3,redImg4]
blueImg1 = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/blue1.png"),cardSize)
blueImg2 = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/blue2.png"),cardSize)
blueImg3 = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/blue1.png"),cardSize)
blueImg4 = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/blue2.png"),cardSize)
blueImgs = [blueImg1,blueImg2,blueImg3,blueImg4]
bystImg1 = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/byst1.png"),cardSize)
bystImg2 = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/byst2.png"),cardSize)
bystImg3 = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/byst1.png"),cardSize)
bystImg4 = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/byst2.png"),cardSize)
bystImgs = [bystImg1,bystImg2,bystImg3,bystImg4]
assnImg = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/assassin.png"),cardSize)
rndNum = random.randrange(0,4)

redOn = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/redOn.png"),(80,80))
redOff = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/redOff.png"),(80,80))
blueOn = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/blueOn.png"),(80,80))
blueOff = pg.transform.scale(pg.image.load(bundle_dir+"/assets/images/blueOff.png"),(80,80))

# Read all words into a list, only once
with open(bundle_dir+"/assets/wordlist.txt", 'r') as f:
...
teamColors = ["Red","Blue"]
# Settings
if os.path.isfile(save_dir+"/settings_Codenames.npy"):
    setVals = np.load(save_dir+"/settings_Codenames.npy")
    timeLim = setVals[0]
    numAssns = setVals[1]
    imgStyle = setVals[2]
else:
...
#----------------------------------------------------------------------------------------------------------------------
def saveGame():
    np.savez(save_dir+"/savedGame_Codenames.npz",words=words, rbFirst=rbFirst, colorCards=colorCards, assnCards=assnCards, bystCards=bystCards, turn=turn, guessing=guessing, guessLeft=guessLeft, score=score, cardsSelected=cardsSelected)
...
def loadGame():
    ...
    fLoaded = np.load(save_dir+"/savedGame_Codenames.npz",allow_pickle=True)
        ...
        for event in pg.event.get():
            ...
            # Key pressed
                ...
                # Quit (ESC)
                    ...
                    np.save(save_dir+"/settings_Codenames.npy",np.array([timeLim,numAssns,imgStyle]))
                    return menu()
